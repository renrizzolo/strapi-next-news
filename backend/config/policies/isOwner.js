...
module.exports = async (ctx, next) => {
  try {
    ...
    if (ctx.request.method === "GET") {
      if (
        Object.prototype.toString.call(ctx.response.body) === "[object Object]"
      ) {
        if (
          typeof ctx.response.body.owner === "undefined" ||
          ctx.response.body.owner === null ||
          typeof ctx.response.body.owner.id === "undefined" ||
          ctx.response.body.owner.id === null ||
          ctx.response.body.owner.id.toString() !== id.toString()
        ) {
